	...
	class EloquentActualPathTest extends InstallComponentTest {
		...
		protected function getModules ():array {
			...
			return [
				$this->replicateModule(ModuleOneDescriptor::class, function (WriteOnlyContainer $container) {
					...
					->replaceWithConcrete(Database::class, $this->replaceConstructorArguments(DatabaseMock::class, [ // refrain from using Models so the real thing doesn't get whacked
		...
		public function test_correctly_writes_to_database_folder () {
			...
			$this->assertInstalledComponent( // when
				...
				$this->getCommandOptions(), true // for further assertions
			);
