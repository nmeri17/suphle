...
{
    final public const PIPE_TO = 12;
    final public const IN_RANGE = 13;
    final public const DATE_RANGE = 14;
    final public const AS_ONE = 15;
    final public const FROM_SERVICE = 16;
