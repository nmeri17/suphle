<?php
	...
	namespace Tilwa\Modules\Auth\Controllers;

	use Models\User;

	// contains old doctrine methods
	class HandleAuth /*extends */ {
		...
		public function signout () {
			...
			unset($_SESSION['tilwa_user_id']); // this should use a modern wrapper enabling us use other drivers
		}
	}
